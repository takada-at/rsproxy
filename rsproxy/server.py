...
class PostgresClientProtocol(FilteringProtocol):
    ...
    def saveAuthMessage(self, msg):
        ...
        log.msg('Saving authentication message: %s' % msg)
    ...
    def terminate(self):
        ...
        is shutting down.
        """
        self.transport.write('X\x00\x00\x00\x04')
